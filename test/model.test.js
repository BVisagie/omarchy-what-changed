...
console.log('notes intake')
{
  ...
  is('release keys are exactly the known set',
    Object.keys(r.releases[0]).sort(), ['body', 'name', 'tag', 'url'])
...
console.log('formatting')
{
  ...
  is('header reads as one line',
    M.headerText(s), '2026-09-08 20:41  ·  omarchy 4.0.2-1 → 4.0.3-1  ·  stable  ·  reboot needed')
  is('counts line', M.countsText(s.counts),
    '145 package changes: 135 upgraded, 5 installed, 4 removed, 1 reinstalled')
  is('one change is singular',
    M.countsText({ upgraded: 1, total: 1 }), '1 package change: 1 upgraded')
